...
<template>
  ...
  >
    ...
    <p class="text-slate-500">
     <NuxtLink to="/LazyProfileUser" @click="sneakerStore.show = !sneakerStore.show" class="text-[#7747ff]"> Войдите </NuxtLink> или <NuxtLink to="/LazySignUp" @click="sneakerStore.show = !sneakerStore.show" class="text-[#7747ff]">зарегистрируйтесь</NuxtLink> чтобы добавлять товары в корзину
    </p>
  </div>
</template>
