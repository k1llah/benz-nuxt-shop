...
<template>
  ...
  >
    ...
    <div class="flex flex-col gap-10">
      <div
        class="border-b-2 border-[#166534] dark:border-[#10b981] pb-[10px] w-[250px]"
      >
      ...
      <div
        class="border-b-2 border-[#166534] dark:border-[#10b981] pb-[10px] w-[250px]"
      >
        <span class="text-slate-400 dark:text-ghostWhiteText text-[16px]"
          >Имя:</span
        >
        <h4 class="text-black text-[20px] dark:text-[#f5f5f5]">
          {{ first_name }}
      ...
      <div class="flex flex-col gap-10 justify-center h-[100%]">
        <div class="pb-[10px]">
          <div class="input bg-[#a8c0df] dark:bg-black">
            <button
              class="value"
              @click="handleOpenPage('orders'), myOrders.getDataOrder()"
            >
              <svg
                viewBox="0 0 16 16"
