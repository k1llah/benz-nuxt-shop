	...
	const submitForm = async (event: Event) => {
		...
		if (
			...
			try {
				...
				textSuccessSignUp.value = 'Произошла ошибка при регистрации. Пожалуйста, попробуйте позже'
			}
...
<template>
	...
	>
		...
		<div
			v-if="isTimerStarted == true"
			class="flex mt-[50px] items-center flex-col text-center justify-center"
		>
